...
var gameWindow; // 追加: gameWindowをグローバルで宣言
...
function loadComplete(){
	...
	gameWindow = document.getElementById('gameWindow'); // 追加: gameWindowを取得
...
// ゲームウィンドウにイベントリスナーを追加
document.addEventListener('DOMContentLoaded', function() {
    var gw = document.getElementById('gameWindow');
    if (gw) {
        gw.addEventListener('touchstart', handleTouchStart, false);
        gw.addEventListener('touchend', handleTouchEnd, false);
    }
});
